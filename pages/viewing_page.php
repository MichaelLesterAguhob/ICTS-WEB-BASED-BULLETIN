...
<head>
    ...
    <link rel="stylesheet" href="../public/assets/css/viewing_page.css">
...
<body>
    <div class="">
        ...
        <div class="intro displays">
            ...
            <video class="intro_icts" id="intro_icts" muted>
                <source src="../public/assets/img/icts_intro.mp4" type="video/mp4">
            </video>
        </div>
        <!--  -->
    ...
    <script src="../public/assets/js/viewing_page.js"></script> 
</body>
</html>