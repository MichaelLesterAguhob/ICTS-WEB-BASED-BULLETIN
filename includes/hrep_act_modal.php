    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <tr>
            ...
            <td style="width: 70%;"><img src="../public/assets/img/default2.png" alt="image" id="hrep_act_img_prev"></td>
        </tr>
        <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <table class="hrep_act_input_table">
        ...
        <tr>
            <th style="width: 30%;">Image:</th>
            <td style="width: 70%;"><img src="../public/assets/img/default.png" alt="image" id="edit_hrep_act_img_prev" style="width: 200px; height:200px;"></td>
        </tr>
