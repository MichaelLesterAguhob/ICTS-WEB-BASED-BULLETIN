...
function verify_email() {
  ...
  if (c_username == "" || c_password == "" || email == "") {
    $(".create_account_failed")
      .attr("class", "alert create_account_failed alert-primary")
      .fadeIn(100)
      .fadeOut(5000);
    $(".create_account_failed").html(
      "<strong>No Input!</strong>" + " " + "Please Fill in the blanks."
    );
  } else {
    $.ajax({
      ...
      success: function (data) {
        try {
          ...
          if (data.stat == "success") {
            $(".create_account_failed")
              .attr("class", "alert create_account_failed alert-info")
              .fadeIn(100)
              .fadeOut(15000);
            $(".create_account_failed").html(
              "<strong> We&apos;ve Sent a Verification Code to " +
                email +
                ".</strong>" +
                " " +
                "Please Check your Email Account Inbox or Spam."
            );
            ...
            $(".create_account_failed")
              .attr("class", "alert create_account_failed alert-warning")
              .fadeIn(100)
              .fadeOut(15000);
            $(".create_account_failed").html(
            ...
            $(".create_account_failed")
              .attr("class", "alert create_account_failed alert-danger")
              .fadeIn(100)
              .fadeOut(5000);
            $(".create_account_failed").html(
              "<strong> " + data.msg + ".</strong>"
  ...
  if (c_username == "" || c_password == "" || email == "") {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.stat == "success") {
          $(".create_account_failed")
            .attr("class", "alert create_account_failed alert-success")
            .fadeIn(100)
            .fadeOut(5000);
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.status == "success") {
          $(".invalid_login").css("visibility", "unset");
          $(".invalid_login")
            .attr("class", "alert invalid_login alert-success")
            .fadeIn(100)
            .fadeOut(3000);
...
function get_recovery_code() {
  ...
  if (recovery_email == "") {
    ...
    $(".acct_recovery_msg").attr(
      "class",
      "alert acct_recovery_msg alert-warning"
    );
    $(".acct_recovery_msg").html(
      "<strong>No Input! </strong>&nbsp; Enter your Email"
    );
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.stat == "success") {
          ...
          $(".acct_recovery_msg").attr(
            "class",
            "alert acct_recovery_msg alert-success"
          );
          $(".acct_recovery_msg").html(
            "<strong>Recovery Code Sent!</strong> Please check your email inbox/spam."
          );
          setTimeout(function () {
            $(".acct_recovery_msg").css("visibility", "hidden");
          }, 3000);
          ...
          $(".acct_recovery_msg").attr(
            "class",
            "alert acct_recovery_msg alert-danger"
          );
  ...
  if (code == "" || new_pass == "") {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $(".acct_recovery_msg").html(
          "<strong>Successfully changed your password! <strong>"
        );
        setTimeout(function () {
          $(".acct_recovery_msg").css("visibility", "hidden");
